...
// useForecastWeather 훅이 인자로 받을 객체의 타입을 정의하는 인터페이스입니다.
...
/**
 * 위도와 경도를 기반으로 해당 위치의 날씨 '예보' 정보를 가져오는 React Query 커스텀 훅입니다.
 * @param {useForecastWeatherProps} { lon, lat } - 위도와 경도
